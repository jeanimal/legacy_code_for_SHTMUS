...
#define DEBUG           1 
#define DEBUG2          1  /* how deep do you like your debugging? */
...
/* used if ASKSAMPLING is on */
/* if Samplingtype == 0, then SampleN is an absolute number */
/* if Samplingtype == 1, then SampleN is a percentage */
long Samplingtype;
double SampleN;
};
