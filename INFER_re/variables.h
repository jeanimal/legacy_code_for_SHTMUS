...
#define CROSSVALIDATE	1 /* if =1, data will be split into two;
				 ...
				 * huh??? It is also safer to turn OFF CUEREVERSE.
				 */

/* To get FITVALIDATE to work, you must also have CROSSVALIDATE on */
#define FITVALIDATE	0
/* new: Jean is testing this for the multiple-split fit on model data, test on model data */
